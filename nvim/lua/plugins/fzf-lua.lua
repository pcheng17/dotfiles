return {
    ...
    keys = {
        ...
        { "<leader>'",   function() require("fzf-lua").oldfiles() end,        mode = "n", desc = "fzf oldfiles",        silent = true },
        { "<leader>.",   function() require("fzf-lua").grep() end,            mode = "n", desc = "fzf grep in cwd",     silent = true },
        { "<leader>fu",  function() require("fzf-lua").buffers() end,         mode = "n", desc = "fzf buffers",         silent = true },
        ...
        { "<leader>fch", function() require("fzf-lua").command_history() end, mode = "n", desc = "fzf command history", silent = true },
        { "<leader>fm",  function() require("fzf-lua").marks() end,           mode = "n", desc = "fzf marks",           silent = true },
        { "<leader>fll", function() require("fzf-lua").loclist() end,         mode = "n", desc = "fzf loclist",         silent = true },
        { "<leader>fqf", function() require("fzf-lua").quickfix() end,        mode = "n", desc = "fzf quickfix",        silent = true },
    --stylua: ignore end
    },
    config = function()
